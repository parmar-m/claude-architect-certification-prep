...
> **Official brief:** Use Claude Code for generation, refactoring, debugging, and documentation. Integrate it with custom commands and `CLAUDE.md`, and choose between plan mode and direct execution.
