...
> **Official brief:** Add Claude Code to CI/CD for code review, test generation, and pull-request feedback. Prompts should produce **useful findings with few false positives**.
